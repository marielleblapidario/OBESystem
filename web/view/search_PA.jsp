                ...
                <section class="content">
                    <div class="box box-success">
                        <div class="box-header with-border">
                            <h3 class="box-title">Search Program for Program Attributes</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form class="form-horizontal">
                            ...
                            <div class="box-footer">  
                               <a id ="confirm-btn" href ="/OBESystem/RedirectToCreatePA"><button type="button" class="btn btn-success pull-right">Confirm</button></a>
                            </div>
                            <!-- /.box-footer -->
                        </form>
                    </div>

                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box box-success">
                                <div class="box-header">
                                    ...
                                    <br>
                                    <a href="/OBESystem/RedirectToCreateSyllabus"><button type="button" id="button-new" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add Syllabus</button></a>

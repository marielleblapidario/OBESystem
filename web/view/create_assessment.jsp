...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <section class="content">
                        <div class="box box-info">
                            ...
                            <div class="box-header">
                                ...
                                <div class="col-sm-10">
                                    <select id="select-approver" name="select-approver" class="form-control select2 select2-hidden-accessible" style="width: 30%;" tabindex="-1" aria-hidden="true">
                                    </select>
                                </div>
                                <br>
                            </div>
        ...
        <script src="/OBESystem/js/create_assessment.js"></script>

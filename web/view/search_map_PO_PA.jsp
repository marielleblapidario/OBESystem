                ...
                <section class="content">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Search Program for Mapping PO to PA</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form class="form-horizontal">
                            ...
                            <div class="box-footer">  
                               <a id ="confirm-btn" href ="/OBESystem/RedirectToMapPOtoPA"><button type="button" class="btn btn-success pull-right">Confirm</button></a>
                            </div>
                            <!-- /.box-footer -->
                        </form>
                    </div>

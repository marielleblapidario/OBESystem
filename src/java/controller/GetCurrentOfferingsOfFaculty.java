 ...
 */
public class GetCurrentOfferingsOfFaculty extends BaseServlet {
    ...
    public void servletAction(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            ArrayList<CourseOffering> offerings = new CourseOfferingDAO().getCurrentOfferingsOfFaculty(userID);

...
public class ProgramDAO {
    ...
    public ArrayList<Program> getAllProgram() throws ParseException {
        ...
        try {
            DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
            Connection conn = myFactory.getConnection();
            String query = "SELECT codeProgram, title, college, contributor, U.firstName, U.lastName\n"
                    + "FROM program P\n"
                    + "JOIN user U\n"
    ...
    public Program getSpecificProgram(String codeProgram) throws ParseException {
        ...
        try {
            DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
            Connection conn = myFactory.getConnection();
            String query = "SELECT codeProgram, title, college, units, description, U.firstName, U.lastName\n"
                    + "FROM program\n"
                    + "JOIN user U\n"
                    + "ON P.contributor = U.userID\n"
                    + "WHERE codeProgram = ?;";
            ...
            while (rs.next()) {
                ...
                program.setContributorFirstName(rs.getString("firstName"));
                program.setContributorLastName(rs.getString("lastName"));
            }
            pstmt.close();
            conn.close();
            return program;
    ...
    public Program searchProgram(String college) throws ParseException {
        Program program = new Program();
